...
<body>
	...
	<div id="container" style="margin: 0 auto; width: 50%;">
	<div id="">
	</div>
		<h4>회원 탈퇴 시 유의사항</h4>
		<div id="warning-message" class="py-3" style="background-color: grey;">
			<ul>
		...
		<div id="agreement-section" class="form-check py-2">
